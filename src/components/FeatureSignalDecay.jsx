    ...
    >
      ...
      <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        <div>
          ...
          <div className="report-card mt-6 p-5">
            <p className="text-xs uppercase tracking-[0.2em] text-slate-400">Clean correlation</p>
            <p className="mt-3 text-3xl font-semibold text-slate-900">{featureDecay.clean_correlation}</p>
          </div>
        </div>
          ...
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={featureDecay.points}>
                ...
                <YAxis />
                <Tooltip />
                <Line type="monotone" dataKey="correlation" stroke="#3b82f6" strokeWidth={3} dot={{ r: 4 }} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </div>
